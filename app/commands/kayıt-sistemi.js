...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (kayitSistemi && kayıtSistemiDate) {
            ...
            .setDescription(`<:carpi:1121054581888139355> | Bu sistem <t:${parseInt(kayıtSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1121054586778681455> | __**Kayıt Sistemi**__ başarıyla ayarlandı!\n\n<:ayarlar:1121055588416237729> Kayıt Kanalı: ${kayıtkanal}\n<:tik:1121054586778681455> Kayıtlı Rolü: ${kayıtlırol}\n<:carpi:1121054581888139355> Kayıtsız Rolü: ${kayıtsızrol}\n <:unlem:1121054576137740318> Unutma Bunun için hesap korumasının açık olması gerek /hesap-koruma `)
