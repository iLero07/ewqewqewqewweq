...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (ozelOdaSystem && ozelOdaSystemDate) {
        ...
        .setDescription(`<:carpi:1121054581888139355> | Bu sistem <t:${parseInt(ozelOdaSystemDate.date / 1000)}:R> önce açılmış!`)
  ...
  const channel = await interaction.guild.channels.create({
    ...
    interaction.reply("<:tik:1121054586778681455> | Sesli Kanal Başarıyla Oluşturuldu.")
}
