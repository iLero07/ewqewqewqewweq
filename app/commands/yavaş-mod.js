...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (zaman < 0 || zaman > 21600) return interaction.reply("<:carpi:1121054581888139355> | Süre limiti maksimum **6** saat olabilir.")
    const slowmode = Math.floor(zaman)
    interaction.channel.setRateLimitPerUser(slowmode)

   interaction.reply(`<:tik:1121054586778681455> | Yazma süre limiti **${zaman}** saniye olarak ayarlanmıştır.`)
