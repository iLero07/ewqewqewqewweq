...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const basarili = new Discord.EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik:1121054586778681455> | Başarıyla Ayarlandı!")
            .setDescription("<:tik:1121054586778681455> | Botlist sistemi başarıyla ayarlandı!")
            .setFooter({ text: "Al Mazrah" })


            const menu = new Discord.EmbedBuilder()
            .setColor("000000")
            .setTitle("<:ekle:1121056565059919932> | Botumu Nasıl Eklerim?")
