...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355>| Sunucu sahibini susturamazsın, nasıl kaldıracaksın?")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Kendi timeoutunu kaldıramazsın, zaten yok.")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Benim susturmam yok ki? Susturamazsında zaten :call_me:")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik:1121054586778681455> | Bir Üye'nin Susturması Kaldırıldı!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1121054586778681455> | ${kullanıcı} adlı üyenin susturmasını kaldırdım.`)
