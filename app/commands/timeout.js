...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!data) return interaction.reply({ content: "<:carpi:1121054581888139355> | Dostum **__Timeout Sistemi__** ayarlanmamış.", ephemeral: true })


        let yetkili = data.yetkili
        let kanal = data.log
        let channel = client.channels.cache.get(kanal)
        if (!channel) return interaction.reply({ content: `<:carpi:1121054581888139355> | Dostum **__Timeout Sistemi__** log kanalı bulunamadı.`, ephemeral: true })

        const uyeYetki = new EmbedBuilder()
            .setColor("Red")
            .setDescription(`<:carpi:1121054581888139355> | Bu komutu kullanabilmek için <@&${yetkili}> rolüne sahip olmalısın!`)

        const botYetki = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Bunu yapabilmek için yeterli yetkiye sahip değilim.")

        const uyeBulunamadi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Belirttiğin üyeyi bulamadım.")

        const pozisyon = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Kullanıcının rolü benim rolümden yüksek.")

        const pozisyon2 = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Kullanıcının rolü senin rolünden yüksek.")

        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Sunucu sahibini susturamazsın dostum.")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Kendine neden timeout atmak istersin ki?")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Ben bir botum, beni susturup ne yapacaksın?")

        const gecerliSure = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Susturabilmem için geçerli bir süre girmelisin.")

        const hata = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1121054581888139355> | Komutu kullanırken bir hata oluştu.")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Yellow")
            .setTitle("<:tik:1121054586778681455> | Bir Üye Susturuldu!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1121054586778681455> | ${kullanıcı} adlı kullanıcıya **${süre}** süre boyunca timeout atıldı!`)
