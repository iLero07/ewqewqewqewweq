...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    switch(saasSystemTrue) {
      case "ac": {
        if(saasSystem) return interaction.reply({ content: "<:carpi:1121054581888139355> | Bu sistem zaten açık!" });
      ...
      case "kapat": {
        if(!saasSystem) return interaction.reply({ content: "<:carpi:1121054581888139355> | Bu sistem zaten kapalı?" });
