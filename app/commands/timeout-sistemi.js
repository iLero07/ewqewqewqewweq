...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (timeoutSistemi && timeoutSistemiDate) {
            ...
            .setDescription(`<:carpi:1121054581888139355> | Bu sistem <t:${parseInt(timeoutSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:carpi:1121054581888139355> | __**Timeout Sistemi**__ başarıyla ayarlandı! __/timeout__ komutu ile sistemi kullanabilirsin.\n\n<:kanal:1121064005205774380> Log Kanalı: ${kanal}\n<:yapaybot:1121058764003483659> Yetkili Rolü: ${rol}`)
