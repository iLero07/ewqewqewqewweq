    ...
    switch(levelSystemTrue) {
      case "ac": {
        ...
        if (levelSystem && levelSystemDate) {
            ...
            .setDescription(`<:carpi:1121054581888139355> | Bu sistem <t:${parseInt(levelSystemDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!levelSystem) return interaction.reply({ content: "<:carpi:1121054581888139355> | Bu sistem zaten kapalı?" });
