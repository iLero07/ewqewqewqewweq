   ...
   switch(hesapkorumaSystemTrue) {
    case "ac": {
      ...
      if (hesapkorumaSystem && hesapkorumaSystemDate) {
          ...
          .setDescription(`<:carpi:1121054581888139355> | Bu sistem <t:${parseInt(hesapkorumaSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!hesapkorumaSystem) return interaction.reply({ content: "<:carpi:1121054581888139355> | Bu sistem zaten kapalı?" });
