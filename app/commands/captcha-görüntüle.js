...
module.exports = {
    ...
    run: async (client, interaction) => {
      ...
      if(!db.fetch(`rcaptcha_${interaction.guild.id}`))
        {
          return interaction.reply({ embeds: [
                ...
                .setDescription('<:carpi:1121054581888139355> **|** rCaptcha doğrulama sistemi `pasif` iken bu işlem yapılamaz.')
              ], fetchReply: true });
        }
      ...
      return interaction.reply({ embeds: [
                ...
                .setColor("#36393F")
                .setAuthor({ name: interaction.user.tag, iconURL: interaction.user.displayAvatarURL({ dynamic: true })})
                .setDescription('<:tik:1121054586778681455> **|** rCaptcha doğrulama sistemini kullandığın için teşekkürler.')
                .addFields(
